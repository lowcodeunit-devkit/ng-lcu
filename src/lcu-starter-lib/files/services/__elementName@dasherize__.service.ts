...
export class <%= classify(elementName) %>Service {

  constructor() { }

  public getCardData(): <%= classify(elementName) %>Model[] {
    return [
      {
        <%= classify(elementName) %>Id: 1,
